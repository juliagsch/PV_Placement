...
def get_subdirectories(path="./out/"):
...
for sample in samples:
    vertices, faces = read_polyshape(os.path.join("./out", sample, "roof.obj"))
    vertices_surroundings, faces_surroundings = read_polyshape(os.path.join("./out", sample, "surroundings3D.obj"))

    plot_building(vertices, faces)
    plot_building_and_surroundings(vertices, faces, vertices_surroundings, faces_surroundings)
    plot_elevation_image(os.path.join("./out", sample, "surroundings2D.csv"), os.path.join("./out", sample, "mask.csv"))